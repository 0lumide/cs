...
public class View extends JPanel implements Runnable{
    ...
    JCheckBoxMenuItem conservativeMode;
    JCheckBoxMenuItem agressiveMode;
    JMenuItem resetModes;
    JFrame frame;
    ...
    public void run() {
        ...
        agressiveMode = new JCheckBoxMenuItem("Agressive Mode");
        agressiveMode.setEnabled(false);
        conservativeMode = new JCheckBoxMenuItem("Conservative Mode");
        conservativeMode.setEnabled(false);
        resetModes = new JMenuItem("Reset Modes");
        resetModes.setEnabled(false);
        agressiveMode.setMnemonic(KeyEvent.VK_A);
        conservativeMode.setMnemonic(KeyEvent.VK_C);
        resetModes.setMnemonic(KeyEvent.VK_E);
        /*viewRequests.setSelected(true);
         viewVolunteers.setSelected(true);*/
        optionsMenu.add(agressiveMode);
        optionsMenu.add(conservativeMode);
        optionsMenu.add(resetModes);
        jmb.add(optionsMenu);
