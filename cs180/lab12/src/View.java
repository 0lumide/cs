...
public class View extends JPanel{
    ...
    private void drawLocation() {
        ...
        while (it.hasNext()) {
            ...
            int x1;
            int y1;
            int yOrig = Integer.parseInt(CoordSplit[1]);
            while (it2.hasNext()) {
                ...
                temp = (String) (model.getRequester2Location()).get(key);
                temp2 = (String) model.getLocation2Coordinate().get(temp);
                
                temp3 = temp2.split(" ");
                x1 = Integer.parseInt(temp3[0]); //Fetches x coordinate
                y1 = Integer.parseInt(temp3[1]); //Fetches y coordinate
                if ((x1 == x) && (y1 == yOrig)) {
            ...
            while (it3.hasNext()) {
                ...
                //using drawName method  
                temp = (String) (model.getVolunteer2Location()).get(key);
                temp2 = (String) model.getLocation2Coordinate().get(temp);
                temp3 = temp2.split(" ");
                x1 = Integer.parseInt(temp3[0]); //Fetches x coordinate
                y1 = Integer.parseInt(temp3[1]); //Fetches y coordinate
    ...
    private void drawIntransit() {
        ...
        while (it.hasNext()) {   
            ...
            g2.drawString(volunteer, x, y + gap - 3);
            ...
            String startLocation = model.getVolunteer2Location().get(volunteer); 
            String startLoc = model.getLocation2Coordinate().get(startLocation);
            ...
            String coordinate = model.getLocation2Coordinate().get(destination);
            ...
            g2.setColor(Color.GREEN); //Sets color to Black for outer circle
