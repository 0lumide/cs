...
/**
 * CS180 -Lab 02 This was a buggy program, I have fixed it.
 *
...
public class BuggyProgram {
    public static void main(String[] args) {
        ...
        // read the string frim the terminal
        ...
        //request and read an email address
        System.out.println("Enter your email address: ");
        String userEmail = s.nextLine();

        //call createBusinessCard() to generate a business card with the user info
